...
public class ElectricityManagement : MonoBehaviour
{
    ...
    private void FindSystemReferencesIfNeeded()
    {
        ...
        if (lightSystem == null)
        {
            lightSystem = FindObjectOfType<Svetlo_Strop_Kancelar_Tlacitko>();
        }
        ...
        if (laserSystem == null)
        {
            laserSystem = FindObjectOfType<VentilaceLaseryDvere>();
        }
        ...
        {
            dvere_kancelar[] doors = FindObjectsOfType<dvere_kancelar>();
            if (doors.Length >= 2)
            {
                door1System = doors[0];
                door2System = doors[1];
        ...
        {
            tlacitka_dvere_kancelar[] doorButtons = FindObjectsOfType<tlacitka_dvere_kancelar>();
